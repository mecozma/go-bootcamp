...
func main() {
	...
	names = []string{}   // The names of your friends    alives    []bool   := {} // Up/Down status of web servers
	distances = []int{}  // The distances
	data = []byte{}      // A data buffer
	ratios = []float64{} // Currency exchange ratios     fmt.Printf("names    : %T %d %t\n", names, len(names), names == nil)
	alives = []bool{}    // Up/Down status of web serversfmt.Printf("distances: %T %d %t\n", distances, len(distances), distances == nil)
