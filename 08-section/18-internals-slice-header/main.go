...
func main() {
	...
	slice1000 := convertedArray[:1000]

	// 8. slice only the elements of the array between 1000 and 10000
	slice10000 := convertedArray[1000:10000]
	...
	fmt.Printf("convertedArray's size: %d bytes.\n", unsafe.Sizeof(convertedArray))
	fmt.Printf("slice1000's size: %d bytes.\n", unsafe.Sizeof(slice1000))
	fmt.Printf("slice10000's size: %d bytes.\n", unsafe.Sizeof(slice10000))
}
